...
def automateservices_page():
    ...
    inner_frame = tk.Frame(automateservices_frame, bd=3, relief="groove", bg="white", width=500, height=400)
    inner_frame.pack(pady=10)
    inner_frame.pack_propagate(False)

    show_automate_services(inner_frame)
...
def rdp_services_page():
    ...
    rdp_services_frame = tk.Frame(main_frame, bg="#f9f9f9")  # Light background
    ...
    # 🔹 Inner bordered frame like a card
    inner_frame = tk.Frame(rdp_services_frame, bd=3, relief="groove", bg="white", width=500, height=400)
    inner_frame.pack(pady=10)
    inner_frame.pack_propagate(False)

    # Call function to populate it
    show_rdp_services(inner_frame)
